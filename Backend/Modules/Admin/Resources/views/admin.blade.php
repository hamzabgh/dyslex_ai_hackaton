                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-700 fw-semi-bold py-1">$1,090
                        <button class="btn p-0" type="button"><span class="fa-solid fa-rotate text-900 ms-1" style="--phoenix-text-opacity: .6;"></span></button>
                      </td>
                    </tr>
                    <tr>
                ...
                <div class="flex-1">
                  <div class="mb-4">
                    <div class="form-check mb-1">
                      ...
                      <label class="form-check-label fs-0 text-900" for="fullfilledBySeller">Fullfilled by Seller</label>
                    </div>
                    <div class="ps-4">
                  ...
                  <div class="mb-4">
                    <div class="form-check mb-1">
                      ...
                      <label class="form-check-label fs-0 text-900 d-flex align-items-center" for="fullfilledByPhoenix">Fullfilled by Phoenix <span class="badge badge-phoenix badge-phoenix-warning fs--2 ms-2">Recommended</span></label>
                    </div>
                    <div class="ps-4">
            ...
            <div class="tab-pane fade" id="productsTabContent" role="tabpanel" aria-labelledby="productsTab">
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label fs-0 text-900" for="worldwideDelivery">Worldwide delivery</label>
                </div>
                <div class="ps-4">
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label fs-0 text-900" for="selectedCountry">Selected Countries</label>
                </div>
              ...
              <div>
                <div class="form-check">
                  ...
                  <label class="form-check-label fs-0 text-900" for="localDelivery">Local delivery</label>
                </div>
